...
class TaskWidget extends StatelessWidget {
  final Tasks? task;
  final bool isAdmin;
  const TaskWidget({super.key, required this.task, required this.isAdmin});

  @override
  Widget build(BuildContext context) {
    if (isAdmin == true) {
      return taskWidgetManager(context);
    } else if (isAdmin == false) {
      return taskWidgetNotManager(context);
    } else {
      return Scaffold(
  ...
  AnimatedContainer taskWidgetManager(BuildContext context) {
  ...
  AnimatedContainer taskWidgetNotManager(BuildContext context) {
    Users? appointer = usersBox.get(task!.appointer.toString());
    Users? appointed = usersBox.get(task!.apoointed.toString());
    return AnimatedContainer(
      margin: EdgeInsets.all(8),
