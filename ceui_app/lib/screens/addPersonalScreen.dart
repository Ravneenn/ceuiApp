...
class addPersonalScreen extends StatefulWidget {
  ...
  @override
  State<addPersonalScreen> createState() => addPersonalScreenState();
}

class addPersonalScreenState extends State<addPersonalScreen> {
                  ...
                  child: Container(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          setupFormsTitle(
                              title: "Setting Staff's information",
                              description:
                                  "this form is also contains Staff's login informations"),
                          SizedBox(
                            height: 15,
                          ),
                          Row(
                          ...
                          Row(
                            ...
                            children: [
                              setupForms(
                                name: "Name",
                                hint: "Type staff's name...",
                                control: userName,
                              ),
                              setupForms(
                                name: "Surname",
                                hint: "Type staff's surname...",
